...
export default function WalletTrackerPopover({
  ...
  // const isBlue =
  //   transaction?.type?.toLowerCase() === "add" || transaction?.firstTrade;

  return (
    <div className="flex items-center gap-x-1">
      {isDeveloper && (
        <Badge className="bg-white/[12%] py-1 leading-3 text-warning hover:bg-white/[12%]">
          DEV
        </Badge>
      )}
      <button
      ...
      >
        ...
        />
        {withCircleCount && <CircleCount value={circleCount} />}
      </button>
    </div>
  );
  // return (
