...
const CosmoCardType2: React.FC<CosmoCardType2Props> = ({
  amount,
  data,
  column,
  isFirst,
  ...
  return (
    <>
      ...
      <div className={cn(cardStyles.content)} style={cardStyles.contentCss}>
        {data?.migration?.migrating && (
          <div className="absolute right-0 top-0 flex w-fit items-center gap-x-1.5 p-1">
                    ...
                    onClick={async (e) => {
                      ...
                      try {
                        if (isTokenHidden) {
                          ...
                          //   />
                          // ));
                          success("Succesfully unhidden token");
        ...
        <div className={cn("flex h-full w-full flex-col justify-around gap-1")}>
          <div className="flex w-full items-center justify-between">
            <div
              className={cn(
                ...
                !data?.migration?.migrating &&
                  cardWidth >= 280 &&
                  (!isSnapOpen || cardWidth >= 430) &&
                  "pr-16",
                isSnapOpen && cardWidth >= 390 && cardWidth <= 430 && "pr-8",
              )}
            >
              <div
                className={cn(
                  ...
                  !data?.migration?.migrating &&
                    cardWidth >= 280 &&
                    (!isSnapOpen || cardWidth >= 430) &&
                    (isSnapOpen ? "max-w-[120px]" : "max-w-[160px]"),
                )}
              >
                {data?.is_discord_monitored && (
                  <TooltipProvider>
                ...
                {/* Closes container for TokenName and Icons */}
                {/* The duplicated icon block that started with !isMediumScreen has been removed as its logic is merged above. */}
              </div>
              {/* <StatBadges
                ...
                isWrap={isMediumScreen}
                className={cn(
                  "flex flex-row flex-nowrap",
                  cardWidth < 270 && "flex-wrap",
                  isSnapOpen &&
                    cardWidth >= 390 &&
                    cardWidth <= 430 &&
                    "mb-0 mt-0.5",
              ...
              <CustomCosmoStats
                ...
                className={
                  (["normal", "large"].includes(currentButtonPreset) &&
                    (cardWidth < 440 || statBadgesWidth > cardWidth * 0.53)) ||
                  (["extralarge", "doubleextralarge"].includes(
                    currentButtonPreset,
                  ) &&
                    (cardWidth < 420 || statBadgesWidth > cardWidth * 0.5)) ||
                  (["tripleextralarge", "quadripleextralarge"].includes(
                    currentButtonPreset,
                  ) &&
                    (cardWidth < 410 || statBadgesWidth > cardWidth * 0.3))
                    ? "w-full"
                    : "w-[90%]"
                }
              />
            ...
            {data?.migration?.migrating ? (
              <SnipeButton
                ...
                className={cn(
                  ...
                  "right-3 top-1/3 translate-y-[45%]",
                  ...
                  ["tripleextralarge", "quadripleextralarge"].includes(
                    ...
                    cn(
                      ...
                      currentButtonPreset === "doubleextralarge" &&
                        "translate-y-[-75%]",
                      (cardWidth < 430 || statBadgesWidth > cardWidth * 0.3) &&
                        TRANSPARENT_BUTTON_CLASS,
                    ),
                )}
              />
          ...
          <div
            className={cn(
              ...
              "items-end",
              ((currentFontPreset === "normal" && cardWidth < 300) ||
                (currentFontPreset === "large" && cardWidth < 340) ||
                (currentFontPreset === "extralarge" && cardWidth < 295) ||
                (currentFontPreset === "doubleextralarge" &&
                  cardWidth < 375)) &&
                "flex flex-col items-start",
              isSnapOpen && cardWidth >= 390 && cardWidth <= 430 && "mt-0 pt-0",
              currentButtonPreset === "doubleextralarge" && "mt-1",
              cardWidth < 375 && "mt-0",
            )}
          >
            <div
            ...
            {/* <StatTexts
              ...
              justify={
                ...
                (currentFontPreset === "large" && cardWidth < 340) ||
                (currentFontPreset === "extralarge" && cardWidth < 295) ||
                (currentFontPreset === "doubleextralarge" && cardWidth < 375)
                  ? "start"
                  : "end"
              }
              data={{
              ...
              className={
                !isSnapOpen && remainingScreenWidth < 1280 ? "!flex-nowrap" : ""
              }
              cardType="type2"
            /> */}
            <CustomCosmoStats
