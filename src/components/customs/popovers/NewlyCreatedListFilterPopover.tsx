...
const dexList: {
  name: DEX;
  iconURL: string;
  dexValue: keyof NewlyCreatedFilterState["filters"]["preview"]["checkBoxes"];
  customClass: string;
}[] = [
  {
    name: "Moonshot",
...
const NewlyCreatedListFilterPopover = React.memo(
  ({
    ...
    const handleApplyFilter = () => {
      ...
      const { filters } = useNewlyCreatedFilterStore.getState();
      const hasChanged =
                        ...
                        return (
                          ...
                          >
                            <div className="flex items-center gap-x-1">
                              ...
                              <div
                                className={cn(
                                  "relative aspect-square h-4 w-4 flex-shrink-0 rounded-full",
                                  dex?.customClass,
                                )}
                              >
                                <Image
